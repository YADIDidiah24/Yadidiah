...
const Education = () => {
  return (
    <section id="education" className="w-full py-20 relative overflow-hidden">
      <style>
        {`
          .vertical-timeline.vertical-timeline-custom-line::before {
            background: var(--tertiary-color, #1A1D23);
          }
        `}
      </style>
      <motion.div
      ...
      <div className='mt-20 flex flex-col max-w-7xl mx-auto px-6'>
        <VerticalTimeline
          className="vertical-timeline-custom-line"
          lineColor="var(--tertiary-color, #1A1D23)"
        >
