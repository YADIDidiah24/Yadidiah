  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          <Image src={media.logo} alt="logo" width={36} height={36} className="w-9 h-9 object-contain" />
        ...
        <div className="sm:hidden flex items-center">
          ...
          >
            <Image
              src={toggle ? media.close : media.menu}
              alt="menu"
              width={28}
              height={28}
      ...
      >
        <div className="flex justify-end p-6">
            <button
                ...
                className="focus:outline-none focus:ring-2 focus:ring-accent rounded-md"
            >
                <Image src={media.close} alt="close" width={28} height={28} className="w-7 h-7 cursor-pointer" />
            </button>
        </div>
